...
# RNN forward propagation - single time step
...
# LSTM forward propagation - single time step
...
# RNN backward propagation - single time step
...
# LSTM backward propagation - single time step
