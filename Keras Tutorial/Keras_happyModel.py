...
def HappyModel(input_shape):
    ...
    # Feel free to use the suggested outline to get started, and run through the whole
    # program once. The come back also try out other network architectures as well. 
